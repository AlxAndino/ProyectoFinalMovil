...
const styles = StyleSheet.create({
  ...
  title: { color: colors.primary, fontSize: 25, fontWeight: 'bold', marginBottom: 20 },
  label: { color: colors.text, fontSize: 15, fontWeight: '600', marginBottom: 7 },
  row: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 16 },
  option: { borderWidth: 1, borderColor: colors.border, paddingVertical: 9, paddingHorizontal: 13, borderRadius: 20, backgroundColor: colors.surface, color: colors.text },
